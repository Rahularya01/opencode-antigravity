...
describe("Models & Catalog", () => {
  it("routes public model IDs and thinking levels to Antigravity runtime IDs", () => {
    expect(getAntigravityRequestModelId("gemini-3.7-flash", "low")).toBe("gemini-3.7-flash-low");
    expect(getAntigravityRequestModelId("gemini-3.7-flash", "high")).toBe("gemini-3.7-flash-high");
